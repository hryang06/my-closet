...
describe("ProductCard — with size table", () => {
  it("renders brand, name, description", () => {
    render(<ProductCard productInfo={withTable} onRecommend={vi.fn()} />);
  ...
  it("shows enabled 사이즈 추천 button", () => {
    render(<ProductCard productInfo={withTable} onRecommend={vi.fn()} />);
  ...
  it("calls onRecommend when 사이즈 추천 clicked", async () => {
    ...
    render(<ProductCard productInfo={withTable} onRecommend={onRecommend} />);
...
describe("ProductCard — without size table", () => {
  it("renders brand, name, description", () => {
    render(<ProductCard productInfo={withoutTable} onRecommend={vi.fn()} />);
